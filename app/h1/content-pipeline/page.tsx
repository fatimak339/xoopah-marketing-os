...
const CALENDARS = [
  ...
  { post: "Content Calendar — July '26", status: "To Do", notes: "July content calendar — to be planned.", channel: "IG Feed, FB Feed" },
  { post: "Community Content Calendar — Broadcast + WhatsApp + FB", status: "To Do", notes: "30-day broadcast/community calendar — Teach/Ask/Show/Belong pillars. Discovery + engagement + adoption research.", channel: "IG Broadcast, WhatsApp, FB Community" },
