...
export default function H2ContentPage() {
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-xl text-sm text-black/60">
          Auto-synced from Notion — tag a page &quot;Content&quot; in the H2
          Document Hub and it lands here on its own.
        </p>
      </div>
      <NotionSyncedSection section="Content" />
    </div>
  );
}
